...
from telegram.ext import (
    CommandHandler, Updater, CallbackContext,
...
def start(update: Update, context: CallbackContext):
    update.message.reply_text("Привіт! Я бот для автоматичних сигналів. Вибери валютні пари командою /pairs")
...
def pair_selected(update: Update, context: CallbackContext):
    ...
    if text in pairs_list:
        ...
        update.message.reply_text("Невідома пара.")
...
def turn_on(update: Update, context: CallbackContext):
    ...
    if not analyzing:
        ...
        update.message.reply_text("Аналіз уже увімкнений або ще не запускался.")
...
def turn_off(update: Update, context: CallbackContext):
    ...
    if analyzing and job_reference:
        ...
        update.message.reply_text("Аналіз вже вимкнений або ще не запускался.")
